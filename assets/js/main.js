...
$(document).ready(function () {
    ...
    $(document).ready(function () {
        $('#About-Event').click(function (event) {
            event.preventDefault();
            const targetSection = $('#about-event');
            $('html, body').animate({
    ...
    $(document).ready(function () {
        $('#The-Events').click(function (event) {
            event.preventDefault();
    ...
    $(document).ready(function () {
        $('#BCA1').click(function (event) {
            event.preventDefault();
            const targetSection = $('#BCA');
            $('html, body').animate({
                scrollTop: targetSection.offset().top
            }, 2000);
        });
